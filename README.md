# Portfolio Personal - Desarrollador Web

## 1. Descripción del Proyecto

Este proyecto es la Práctica Formativa Obligatoria 1 para la Tecnicatura Superior de Desarrollo de Software. Consiste en la maquetación de un portafolio web personal utilizando HTML5 y CSS3 puro, siguiendo las metodologías de CSS Grid y Flexbox. El diseño cuenta con una estética "Neo-Brutalista", destacando bordes marcados, sombras sólidas, colores contrastantes y microinteracciones dinámicas.
